...
<head>
    ...
    <title>Admin Page - theatron Leadership Club</title>
    <style>
...
<h1>Admin Page - theatron Club</h1>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['answer'], $_POST['question_id'], $_POST['submit_answer'])) {
    ...
    $fetchQuestionQuery = "SELECT name, email, question FROM theatron_con WHERE id = $questionId";
    ...
    $insertQuery = "INSERT INTO theatron_answer (email, question, answer) VALUES ('$email', '$question', '$answer')";
    ...
    if (!$insertResult) {
        ...
        $deleteQuery = "DELETE FROM theatron_con WHERE id = $questionId";
...
$query = "SELECT * FROM theatron_con";
